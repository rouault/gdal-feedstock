...
cmake -G "Unix Makefiles" \
      ...
      -DOGR_REGISTER_DRIVER_OPENJPEG_FOR_LATER_PLUGIN=ON \
      ...
      -DOGR_DRIVER_OPENJPEG_PLUGIN_INSTALLATION_MESSAGE="You may install it with with 'conda install -c conda-forge libgdal-openjpeg'" \
