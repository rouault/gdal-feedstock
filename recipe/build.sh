...
cmake -G "Unix Makefiles" \
      ...
      -DGDAL_USE_KEA=OFF \
      -DOGR_REGISTER_DRIVER_ARROW=OFF \
      -DOGR_REGISTER_DRIVER_PARQUET=OFF \
      -DGDAL_REGISTER_DRIVER_JP2OPENJPEG=OFF \
      -DGDAL_REGISTER_DRIVER_PDF=OFF \
      -DGDAL_REGISTER_DRIVER_POSTGISRASTER=OFF \
      -DOGR_REGISTER_DRIVER_PG=OFF \
      -DGDAL_REGISTER_DRIVER_FITS=OFF \
      -DOGR_REGISTER_DRIVER_XLS=OFF \
      -DGDAL_REGISTER_DRIVER_GRIB=OFF \
      -DGDAL_REGISTER_DRIVER_KEA=OFF \
